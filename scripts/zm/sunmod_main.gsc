...
add_weapons() {
    ...
    include_weapon("dualoptic_saritch_upgraded_zm", 0);
    include_weapon("evoskorpion_upgraded_zm", 0);
    include_weapon("evoskorpion_zm");
    include_weapon("fivesevendw_upgraded_zm", 0);
    include_weapon("fivesevendw_zm");
    include_weapon("fivesevenlh_upgraded_zm", 0);
    include_weapon("fivesevenlh_zm");
    ...
    include_weapon("gl_tar21_zm");
    include_weapon("gl_type95_zm");
    include_weapon("gl_xm8_zm");
    ...
    include_weapon("m1911lh_upgraded_zm", 0);
    ...
    include_weapon("sf_qcw05_upgraded_zm", 0);
...
init_levelvars__override()
{
    ...
    if (getdvarint("sun_gameDifficulty") < 2)
        startPoints = 1000;
    level.player_starting_points = getdvarint("sun_debugEnabled") > 0 ? 999999 : level.round_number * startPoints;
...
on_player_connected() {
    ...
    for (;;) {
        ...
        if (getdvarint("sun_debugEnabled") == 1)
