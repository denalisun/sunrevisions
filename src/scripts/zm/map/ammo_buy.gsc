...
spawn_ammo_buy(position, angles) {
    ammobuy = spawn("script_model", position);
    ammobuy setmodel("zombie_ammocan");
    ammobuy.angles = angles;
    ammobuy.script_noteworthy = "AMMO_BUY";
    collision = spawn("script_model", position);
