...
CoD.PrivateGameLobby.GameTypeSettings[1].id = "startRound"
CoD.PrivateGameLobby.GameTypeSettings[1].name = "ZMUI_STARTING_ROUND_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[1].hintText = "ZMUI_STARTING_ROUND_DESC"
CoD.PrivateGameLobby.GameTypeSettings[1].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[1].labels[1] = "1"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[2] = "5"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[3] = "10"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[4] = "15"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[5] = "20"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[6] = "25"
CoD.PrivateGameLobby.GameTypeSettings[1].labels[7] = "30"
CoD.PrivateGameLobby.GameTypeSettings[1].values = {}
CoD.PrivateGameLobby.GameTypeSettings[1].values[1] = 1
CoD.PrivateGameLobby.GameTypeSettings[1].values[2] = 5
CoD.PrivateGameLobby.GameTypeSettings[1].values[3] = 10
CoD.PrivateGameLobby.GameTypeSettings[1].values[4] = 15
CoD.PrivateGameLobby.GameTypeSettings[1].values[5] = 20
CoD.PrivateGameLobby.GameTypeSettings[1].values[6] = 25
CoD.PrivateGameLobby.GameTypeSettings[1].values[7] = 30
...
CoD.PrivateGameLobby.GameTypeSettings[2].id = "magic"
CoD.PrivateGameLobby.GameTypeSettings[2].name = "ZMUI_MAGIC_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[2].hintText = "ZMUI_MAGIC_DESC"
CoD.PrivateGameLobby.GameTypeSettings[2].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[2].labels[1] = "MENU_ENABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[2].labels[2] = "MENU_DISABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[2].values = {}
CoD.PrivateGameLobby.GameTypeSettings[2].values[1] = 1
CoD.PrivateGameLobby.GameTypeSettings[2].values[2] = 0
CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes = {}
CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[1] = "zstandard"
CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[2] = "zgrief"
CoD.PrivateGameLobby.GameTypeSettings[3] = {}
CoD.PrivateGameLobby.GameTypeSettings[3].id = "headshotsonly"
CoD.PrivateGameLobby.GameTypeSettings[3].name = "ZMUI_HEADSHOTS_ONLY_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[3].hintText = "ZMUI_HEADSHOTS_ONLY_DESC"
CoD.PrivateGameLobby.GameTypeSettings[3].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[3].labels[1] = "MENU_DISABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[3].labels[2] = "MENU_ENABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[3].values = {}
CoD.PrivateGameLobby.GameTypeSettings[3].values[1] = 0
CoD.PrivateGameLobby.GameTypeSettings[3].values[2] = 1
CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes = {}
CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[2] = "zstandard"
CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[3] = "zgrief"
...
CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[2] = "zclassic"
CoD.PrivateGameLobby.GameTypeSettings[5] = {}
CoD.PrivateGameLobby.GameTypeSettings[5].id = "cleansedLoadout"
CoD.PrivateGameLobby.GameTypeSettings[5].name = "ZMUI_CLEANSED_LOADOUT_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[5].hintText = "ZMUI_CLEANSED_LOADOUT_DESC"
CoD.PrivateGameLobby.GameTypeSettings[5].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[5].labels[1] = "ZMUI_CLEANSED_LOADOUT_SHOTGUN_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[5].labels[2] = "ZMUI_CLEANSED_LOADOUT_GUN_GAME_CAPS"
...
CoD.PrivateGameLobby.GameTypeSettings[5].gameTypes[1] = "zcleansed"

-- Sun's Revisions stuff
CoD.PrivateGameLobby.SunModSettings = {}
CoD.PrivateGameLobby.SunModSettings[1] = {}
CoD.PrivateGameLobby.SunModSettings[1].id = "sun_gameDifficulty"
CoD.PrivateGameLobby.SunModSettings[1].name = "ZMUI_DIFFICULTY_CAPS"
CoD.PrivateGameLobby.SunModSettings[1].hintText = "ZMUI_DIFFICULTY_DESC"
CoD.PrivateGameLobby.SunModSettings[1].labels = {}
CoD.PrivateGameLobby.SunModSettings[1].labels[1] =  "ZMUI_DIFFICULTY_NORMAL_SUN_CAPS"
CoD.PrivateGameLobby.SunModSettings[1].labels[2] = "ZMUI_DIFFICULTY_HARD_CAPS"
CoD.PrivateGameLobby.SunModSettings[1].labels[3] = "ZMUI_DIFFICULTY_RAMPAGE_CAPS"
CoD.PrivateGameLobby.SunModSettings[1].labels[4] =  "ZMUI_DIFFICULTY_EASY_SUN_CAPS"
CoD.PrivateGameLobby.SunModSettings[1].values = {}
CoD.PrivateGameLobby.SunModSettings[1].values[1] = 1
CoD.PrivateGameLobby.SunModSettings[1].values[2] = 2
CoD.PrivateGameLobby.SunModSettings[1].values[3] = 3
CoD.PrivateGameLobby.SunModSettings[1].values[4] = 0
CoD.PrivateGameLobby.SunModSettings[1].gameTypes = {}
CoD.PrivateGameLobby.SunModSettings[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.SunModSettings[1].gameTypes[2] = "zstandard"
CoD.PrivateGameLobby.SunModSettings[1].gameTypes[3] = "zgrief"

CoD.PrivateGameLobby.SunModSettings[2] = {}
CoD.PrivateGameLobby.SunModSettings[2].id = "sun_disableFog"
CoD.PrivateGameLobby.SunModSettings[2].name = "ZMUI_SUN_FOG_CAPS"
CoD.PrivateGameLobby.SunModSettings[2].hintText = "ZMUI_SUN_FOG_DESC"
CoD.PrivateGameLobby.SunModSettings[2].labels = {}
CoD.PrivateGameLobby.SunModSettings[2].labels[1] =  "ON"
CoD.PrivateGameLobby.SunModSettings[2].labels[2] = "OFF"
CoD.PrivateGameLobby.SunModSettings[2].values = {}
CoD.PrivateGameLobby.SunModSettings[2].values[1] = 0
CoD.PrivateGameLobby.SunModSettings[2].values[2] = 1
CoD.PrivateGameLobby.SunModSettings[2].gameTypes = {}
CoD.PrivateGameLobby.SunModSettings[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.SunModSettings[2].gameTypes[2] = "zstandard"
CoD.PrivateGameLobby.SunModSettings[2].gameTypes[3] = "zgrief"
CoD.PrivateGameLobby.SunModSettings[2].maps = {}
CoD.PrivateGameLobby.SunModSettings[2].maps[1] = "zm_transit"

CoD.PrivateGameLobby.SunModSettings[3] = {}
CoD.PrivateGameLobby.SunModSettings[3].id = "sun_startingLoadout"
CoD.PrivateGameLobby.SunModSettings[3].name = "ZMUI_SUN_LOADOUT_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].hintText = "ZMUI_SUN_LOADOUT_DESC_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].labels = {}
CoD.PrivateGameLobby.SunModSettings[3].labels[1] = "ZMUI_SUN_LOADOUT_1911_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].labels[2] = "ZMUI_SUN_LOADOUT_MP5_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].labels[3] = "ZMUI_SUN_LOADOUT_FAL_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].labels[4] = "ZMUI_SUN_LOADOUT_BALLISTA_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].labels[5] = "ZMUI_SUN_LOADOUT_REMINGTON_CAPS"
CoD.PrivateGameLobby.SunModSettings[3].values = {}
CoD.PrivateGameLobby.SunModSettings[3].values[1] = "m1911_zm"
CoD.PrivateGameLobby.SunModSettings[3].values[2] = "c96_zm"
CoD.PrivateGameLobby.SunModSettings[3].values[3] = "beretta93r_zm"
CoD.PrivateGameLobby.SunModSettings[3].gameTypes = {}
CoD.PrivateGameLobby.SunModSettings[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.SunModSettings[3].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.SunModSettings[4] = {}
CoD.PrivateGameLobby.SunModSettings[4].id = "sun_debugEnabled"
CoD.PrivateGameLobby.SunModSettings[4].name = "ZMUI_SUN_DEBUG_CAPS"
CoD.PrivateGameLobby.SunModSettings[4].hintText = "ZMUI_SUN_DEBUG_DESC"
CoD.PrivateGameLobby.SunModSettings[4].labels = {}
CoD.PrivateGameLobby.SunModSettings[4].labels[1] = "OFF"
CoD.PrivateGameLobby.SunModSettings[4].labels[2] = "ON"
CoD.PrivateGameLobby.SunModSettings[4].values = {}
CoD.PrivateGameLobby.SunModSettings[4].values[1] = 0
CoD.PrivateGameLobby.SunModSettings[4].values[2] = 1

CoD.PrivateGameLobby.DvarDefaults = {}
CoD.PrivateGameLobby.DvarDefaults["sv_cheats"] = 0
CoD.PrivateGameLobby.DvarDefaults["sun_disableFog"] = 0
CoD.PrivateGameLobby.DvarDefaults["sun_debugEnabled"] = 0
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.SunModSettings, "dvar")
