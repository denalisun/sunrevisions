...
-- CoD.PrivateGameLobby.SunModSettings[2].id = "sun_startingLoadout"
-- CoD.PrivateGameLobby.SunModSettings[2].name = "ZMUI_SUN_LOADOUT_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].hintText = "ZMUI_SUN_LOADOUT_DESC_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].labels = {}
-- CoD.PrivateGameLobby.SunModSettings[2].labels[1] = "ZMUI_SUN_LOADOUT_1911_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].labels[2] = "ZMUI_SUN_LOADOUT_MP5_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].labels[3] = "ZMUI_SUN_LOADOUT_M16_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].labels[4] = "ZMUI_SUN_LOADOUT_DSR_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].labels[5] = "ZMUI_SUN_LOADOUT_REMINGTON_CAPS"
-- CoD.PrivateGameLobby.SunModSettings[2].values = {}
-- CoD.PrivateGameLobby.SunModSettings[2].values[1] = "m1911_zm"
-- CoD.PrivateGameLobby.SunModSettings[2].values[2] = "mp5k_zm"
-- CoD.PrivateGameLobby.SunModSettings[2].values[3] = "m16_zm"
-- CoD.PrivateGameLobby.SunModSettings[2].values[4] = "dsr50_zm"
-- CoD.PrivateGameLobby.SunModSettings[2].values[5] = "870mcs_zm"
